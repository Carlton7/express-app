...
//PUT curl command
//curl -s -X PUT http://localhost:8080/update/1 -H 'Content-type:application/json' -d '{"name" : "updated"}'

//DELETE curl command
//curl -s -X DELETE http://localhost:8080/delete/1 -H 'Content-type:application/json'
